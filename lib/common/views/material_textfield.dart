      ...
      children: [
        ...
        SlideTransition(
          ...
          child: TextFormField(
            ...
            obscureText: widget.textFieldDataObject.isPassword ? hidePassword : false,
            decoration: InputDecoration(
              filled: true,
              fillColor: widget.textFieldDataObject.error != null ? DimsColors.lighterError : const Color(0xFFDADADA),
              border: InputBorder.none,
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(ScreenUtil().setHeight(10)),
                borderSide: BorderSide(
                  color: widget.textFieldDataObject.error != null ? DimsColors.error : Colors.transparent
                ),
              ),
              ...
              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(ScreenUtil().setHeight(10)), borderSide: const BorderSide(color: Colors.transparent)),
              errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(ScreenUtil().setHeight(10)), borderSide: BorderSide(color: DimsColors.error)),
              focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(ScreenUtil().setHeight(10)), borderSide: BorderSide(color: DimsColors.error)),
              ...
              prefixIcon: widget.textFieldDataObject.icon != null ? Padding(
